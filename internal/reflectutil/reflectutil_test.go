...
func TestTypeOf(t *testing.T) {
	...
	t.Run("pointer to struct", func(t *testing.T) {
		var v *struct{}
		got := TypeOf(v)
		assert.Equal(t, PointerStruct, got)
	})
	...
	t.Run("pointer to primitive", func(t *testing.T) {
		var v *string
		got := TypeOf(v)
		assert.Equal(t, PointerPrimitive, got)
	})
	...
	t.Run("slice pointer to struct", func(t *testing.T) {
		var v []*struct{}
		got := TypeOf(v)
		assert.Equal(t, SlicePointerStruct, got)
	})
	...
	t.Run("slice pointer to map", func(t *testing.T) {
		var v []*map[string]any
		got := TypeOf(v)
		assert.Equal(t, SlicePointerMap, got)
	})
	...
	t.Run("slice pointer to primitive", func(t *testing.T) {
		var v []*string
		got := TypeOf(v)
		assert.Equal(t, SlicePointerPrimitive, got)
	})
